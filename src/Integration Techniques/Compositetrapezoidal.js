...
import ShowCompositetrapezoidal from '../component/componentnumer/showCompositetrapezoidal'
var Algebrite = require('algebrite'); 

export default class Compositetrapezoidal extends Component {
    ...
    componentDidMount()
    {
        ...
        axios.get("http://192.168.99.100:8080/api/users/showCompositetrapezoidal").then(res=>{
    ...
    evaluate (){
        ...
        A[i]=b
        B[i]=f(fx,b)
        var result=(h/2)*(B[0]+B[B.length-1]+(2*num))
    ...
    sendDatatoDB = ()=>{
        axios.post('http://192.168.99.100:8080/api/users/addCompositetrapezoidal',{equation:this.state.equation,a:this.state.a,b:this.state.b,n:this.state.n})
        .then(res=>{
            console.log(res);
        })
        this.evaluate()
    ...
    render()
    {
        return(
            <div style={{width:750}}>
                    ...
                    {<ShowCompositetrapezoidal users={this.state.users}/>}
                    <div id='myDiv'></div>
                    <br></br>
                    <div id='myDiv3'></div>
            </div>  
