...
import ShowJacobi from '../component/componentnumer/showJacobi'
...
export default class Jacobi extends Component {
    ...
    componentDidMount()
    {
        ...
        axios.get("http://192.168.99.100:8080/api/users/showJacobi").then(res=>{
    ...
    evaluate= ()=>{
        ...
        var k=0
        var x = Array.from(Array(50), () => new Array())
        var err = Array.from(Array(50), () => new Array())
        for(i=0;i<n;i++){
            x[0][i]=0
        }
        j=0
    ...
    sendDatatoDB = ()=>{
        ...
        axios.post('http://192.168.99.100:8080/api/users/addJacobi',{equation:this.state.equation})
        .then(res=>{
            console.log(res);
        })
        this.evaluate()
    ...
    render()
    {
        return(
            <div >
                    ...
                    <br/>
                    {<ShowJacobi users={this.state.users}/>}
                    { this.state.show && <Box />}
                    <div id='myDiv'></div>
