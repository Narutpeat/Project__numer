...
import ShowGaussElimination from '../component/componentnumer/showGaussElimination'
var Algebrite = require('algebrite'); 
window.$X = []
window.$size = 0
export default class GaussElimination extends Component {
    ...
    componentDidMount()
    {
        ...
        axios.get("http://192.168.99.100:8080/api/users/showGaussElimination").then(res=>{
    ...
    sendDatatoDB = ()=>{
        ...
        axios.post('http://192.168.99.100:8080/api/users/addGaussElimination',{equation:this.state.equation})
        .then(res=>{
            console.log(res);
        })
        this.evaluate()
    ...
    render()
    {
        return(
            <div>
                    <h3>Gauss-Elimination Method</h3>
                    <br/>
                    <h4>Input Size</h4>
                    <div style={{width:50}} >
                    ...
                    <br/>
                    {<ShowGaussElimination users={this.state.users}/>}
                    <div id='myDiv'></div>
            </div>  
        )
    }
